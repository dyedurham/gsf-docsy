...
```plantuml
@startuml container_vnext
!include https://raw.githubusercontent.com/plantuml-stdlib/C4-PlantUML/master/C4_Container.puml
!include https://raw.githubusercontent.com/plantuml-stdlib/C4-PlantUML/master/C4_Component.puml

Person(person_lawyer, "Our Customer")

System_Boundary(c1, "VNext"){
    Container(container_matters_ui, "Matters UI", "Flutter microsite", "Main user interface for VNext")
    ...
    Container(container_precedents_word_addin, "precedents_word", "Microsoft Office Add-in- Flutter Microsite", "Addin for Microsoft Word allowing users to code precedents for merging via VNext")
...
System_Boundary(c2, "GSF"){
    ...
    Container(container_gsf_document_assembly, "GSF.Provider.DocumentAssembly", "C# microservice", "Storage of Precedent documents (also provides Document Assembly via XpressDocs for OP and existing projects portal but not for VNext")
}
